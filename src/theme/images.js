import beigeWhoIAm from "../assets/png/who I am.png"
...
export {
    beigeWhoIAm, blueThemeboy, blueThemegirl, bwThemeboy,
    bwThemegirl, contactsBlack, contactsBlue, contactsGreen,
    contactsOrange,
    contactsPink,
    contactsPurple,
    contactsRed,
    contactsYellow, eduBlack, eduBlue, eduGreen,
    eduOrange,
    eduPink,
    eduPurple,
    eduRed,
    eduYellow, expBlack, expBlue, expGreen,
    expOrange,
    expPink,
    expPurple,
    expRed,
    expYellow, greenThemeboy,
    greenThemegirl,
    orangeThemeboy,
    orangeThemegirl,
    pinkThemeboy,
